...
- **Section** : `/patrimoine`
- **Sous-sections** : Communes (Le Haillan, Mérignac, Pessac...)
- **Articles** : Lieux historiques, curiosités locales, visites
...
**Exemples patrimoine :**
- `patrimoine-le-haillan` → Patrimoine du Haillan
- `patrimoine-merignac` → Patrimoine de Mérignac
...
### Exemple : Patrimoine d'une commune

**Étape 1 - Créer catégorie :**

| Nom | Slug |
|-----|------|
| Patrimoine - Le Haillan | `patrimoine-le-haillan` |

**Étape 2 - Créer page :**

| Titre | Slug | ACF context_section |
|-------|------|---------------------|
| Le Haillan | le-haillan | Patrimoine |

**Étape 3 - Publier articles :**

- "Château de la Rivière" → Catégorie `patrimoine-le-haillan`
- "Moulin de Canteret" → Catégorie `patrimoine-le-haillan`

**Résultat :** `/patrimoine/le-haillan`

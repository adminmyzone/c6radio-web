...
function DynamicPage() {
  ...
  //
  // DEUX CAS POSSIBLES :
  // 1. Route dynamique /:slug  (ex: /mon-article)  → useParams() donne { slug: "mon-article" }
  // 2. Route statique  /contact (ex: /contact)     → useParams() donne {}  (slug = undefined)
  //
  // Pour le cas 2, on lit directement le pathname depuis useLocation()
  // et on extrait le premier segment (ex: "/contact" → "contact")

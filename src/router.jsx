...
import DesktopOnlyPage from "./pages/DesktopOnlyPage.jsx";
import News from "./pages/News.jsx";
import NewsDetail from "./pages/NewsDetail.jsx";
import ContextualHome from "./pages/ContextualHome.jsx";
import ContextualPage from "./pages/ContextualPage.jsx";
// Les contextes elections, evenements et patrimoine réutilisent les mêmes composants
...
export const router = createBrowserRouter([
  {
    ...
    children: [             // Pages enfants qui s'affichent dans <Outlet />
      ...
      {
        path: 'contact',    // Page Contact - accessible partout
        element: <DynamicPage />,
      },
      {
        path: 'partenaires', // Page Nos Partenaires - accessible partout
        element: <DynamicPage />,
      },
      {
        path: 'prestations', // Page Nos Prestations - accessible partout
        element: <DynamicPage />,
      },
      {
        path: 'appli',      // Page Appli - desktop uniquement
        element: <DesktopOnlyPage />,
      },
      {
      ...
      {
        path: 'patrimoine',  // Page d'accueil section Patrimoine/Découverte
        element: <ContextualHome context="patrimoine" />,
      },
      {
        path: 'patrimoine/:subcategory', // Page d'une commune (patrimoine)
        element: <ContextualPage context="patrimoine" />,
      },
      {
